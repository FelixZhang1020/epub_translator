...
class BookAnalysisService:
    ...
    async def analyze_book(
        ...
        if custom_system_prompt or custom_user_prompt:
            ...
            system_prompt = custom_system_prompt or PromptLoader.load_template("analysis").system_prompt
            user_prompt = custom_user_prompt or PromptLoader.render(
                PromptLoader.load_template("analysis").user_prompt_template,
                variables
            )
            # Render system prompt with variables too
            system_prompt = PromptLoader.render(system_prompt, variables)
            user_prompt = PromptLoader.render(user_prompt, variables) if not custom_user_prompt else user_prompt
        else:
